...
const payload = {
  ...
  urlList: [
    ...
    new URL("tools/worldcup-advisor/fixtures/", normalizedSiteUrl).toString(),
    new URL("tools/worldcup-advisor/advisor/", normalizedSiteUrl).toString(),
    new URL("tools/worldcup-advisor/groups/", normalizedSiteUrl).toString(),
    new URL("tools/worldcup-advisor/history/", normalizedSiteUrl).toString(),
    new URL("tools/worldcup-advisor/review/", normalizedSiteUrl).toString(),
    new URL("tools/worldcup-advisor/teams/", normalizedSiteUrl).toString(),
    ...
    new URL("en/tools/photo-booth/online-photo-booth/", normalizedSiteUrl).toString(),
    new URL("en/tools/photo-booth/photo-strip-maker/", normalizedSiteUrl).toString(),
    new URL("en/tools/photo-booth/korean-photo-booth-online/", normalizedSiteUrl).toString(),
    new URL("en/tools/photo-booth/photo-booth-templates/", normalizedSiteUrl).toString(),
    new URL("en/tools/photo-booth/browser-photo-booth/", normalizedSiteUrl).toString(),
