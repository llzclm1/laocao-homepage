...
只记录搜索阶段找到的候选问题、判断和后续价值，未实际回答前不进入海外发帖台账。
...
| 2026-07-02 | Alibaba 供应商真实性 | How do I check if the supplier on Alibaba is legit? | https://www.quora.com/How-do-I-check-if-the-supplier-on-Alibaba-is-legit/answer/%E9%9B%B7%E9%B8%A3-%E6%9B%B9 | 已回答 | 已发布无链接答案，补充付款主体、公司名、样品、视频、验货和异常付款风险 |

## 使用规则

- 找到相近问题先记这里，不直接回答。
- 要写回答时，先停在内容阶段，把大致内容交给用户/ChatGPT 编辑。
- 用户给回最终文本后才填入 Quora，最终发布前再次确认。
